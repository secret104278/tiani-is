...
export const MASTER_WORK_ROLES = [
  ...
  { key: "offering", label: "獻供執禮", type: "dual" },
  { key: "kneelingReception", label: "跪接執禮", type: "dual" },
  { key: "servingFruit", label: "端果", type: "single" },
  { key: "arrangingFruit", label: "整果", type: "multiple" },
  { key: "invokingAltar", label: "請壇執禮", type: "dual" },
  { key: "accompanyingAltar", label: "陪壇", type: "multiple" },
  { key: "performingCeremony", label: "辦道執禮", type: "dual" },
  { key: "incenseOffering", label: "獻香執禮", type: "dual" },
  { key: "greetingAndFarewell", label: "參辭駕執禮", type: "dual" },
  ...
  { key: "towelsAndTea", label: "淨手毛巾", type: "multiple" },
  { key: "threeTreasures", label: "三寶", type: "single" },
] as const;

export const WORK_ROLE_PRESETS = {
  offering: {
    label: "獻供模式",
